...
INSERT INTO `t_user_group` VALUES (1,'业务',0,'/project?tag=my'),(2,'出纳',0,'/project?tag=list_confirm&state_id=49'),(3,'财务',0,'/project?tag=list_confirm&state_id=51'),(5,'合同确认',0,'/project?tag=list_confirm&state_id=50'),(6,'电销',0,'/project?tag=list_confirm&state_id=52'),(7,'跟单分配员',0,'/project?tag=projects_state'),(8,'管理员',0,'/project?tag=allview'),(9,'跟单员',0,'/project?tag=projects_qc'),(10,'会计',0,'/customer?my=1'),(11,'仓管',0,'/project?tag=projects_cg'),(12,'外勤',0,'/project?tag=projects_transition'),(13,'客服顾问',0,'/project?tag=relation_projects'),(14,'人事行政',0,'/project?tag=express_list');
