...
--
-- Table structure for table `t_customer_payment`
--
...
CREATE TABLE `t_customer_payment` (
  ...
  `service_month_amount` decimal(18,2) DEFAULT '0.00',
  `service_year_amount` decimal(18,2) DEFAULT '0.00',
  `book_amount` decimal(18,2) DEFAULT '0.00',
...
--
-- Dumping data for table `t_customer_payment`
--

LOCK TABLES `t_customer_payment` WRITE;
/*!40000 ALTER TABLE `t_customer_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_customer_payment` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-11-09 17:32:39
